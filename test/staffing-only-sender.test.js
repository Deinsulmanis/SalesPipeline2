...
// both deniels inboxes active via the runtime overlay at 20/2, and
...
test('dental: with every other inbox exhausted the lead waits instead of falling through to scalelabaiteam', () => {
  const senders = roster();
  const full = new Map([['primary', 50], ['tryscalelabai', 50], ['deniels', 20], ['deniels_tryscalelabai', 20], ['scalelabaiteam', 0]]);
